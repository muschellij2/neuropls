...
#' @param design_list the file or list of files containing the design matrix information
#' @param folding_dimension name of dimension will be folded into the columns of the X matrix.
#' @param block_ids Ids for the blocks
#' @param blocking_dimension this dimension will be treated as experimental 
#' units or blocks (e.g. subject, session)
